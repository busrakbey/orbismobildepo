...
/**
 * Created by Omer Yildirim on 20.2.2016.
 */
public class TreeListAdapter  extends ArrayAdapter<OrtakAgacTuru> {
    public TreeListAdapter(Context context, int resource, List<OrtakAgacTuru> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
         OrtakAgacTuru item = getItem(position);
