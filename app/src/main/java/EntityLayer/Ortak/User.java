...
public class User extends BaseEntity implements Serializable {
    ...
    public void setDogumTarihi(final String dogumTarihi){
    ...
    public void setGunlemeZamani(final String gunlemeZamani){
    ...
    public boolean equals(Object o) {
        ...
        if ( superId==null)
            return false;
        return  superId.equals(((User) o). superId);
    }
